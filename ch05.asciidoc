...
(I find this line a little confusing). Remember the as part of valid transaction the UTXO are being rearranged reshuffled from one address to another address.
